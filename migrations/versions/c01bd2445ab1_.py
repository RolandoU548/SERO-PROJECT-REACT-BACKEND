...
Revision ID: c01bd2445ab1
Revises: 
Create Date: 2023-11-20 20:15:36.383913
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('invitation_hash', sa.String(length=9999), nullable=False),
    sa.Column('table_user_id', sa.Integer(), nullable=False),
    sa.Column('expired_form', sa.Boolean(), nullable=False),
    sa.ForeignKeyConstraint(['table_user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
